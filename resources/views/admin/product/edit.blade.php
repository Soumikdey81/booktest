            ...
            <div class="card-body">
                <form action="{{route('admin.product.update', $product->id)}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="input/.Status">Child Category</label>
                        <select id="inputStatus" class="form-control child-category" name="child_category">
                            <option value="0">Select</option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" min="0" class="form-control" name="qty" value="{{$product->quantity}}">
                  </div>
                  <div class="form-group">
